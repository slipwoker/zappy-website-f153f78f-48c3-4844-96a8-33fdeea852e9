        ...
        contactForm.addEventListener('submit', function(e) {
            ...
            fields.forEach(function(field) {
                ...
                if (field.hasAttribute('minlength')) {
                    ...
                    if (field.value.trim().length < min && field.value.trim() !== '') {
            ...
            if (isValid) {
                ...
                setTimeout(function() {
                    ...
                    var successMsg = contactForm.querySelector('.form-success') || document.createElement('div');
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: 'f153f78f-48c3-4844-96a8-33fdeea852e9',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || 'f153f78f-48c3-4844-96a8-33fdeea852e9';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = 'f153f78f-48c3-4844-96a8-33fdeea852e9';
